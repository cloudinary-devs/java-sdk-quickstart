This small Java project shows the finished result of the [Java SDK Quick Start](https://cloudinary.com/documentation/java_quickstart) instructions provided in the Cloudinary documentation.
